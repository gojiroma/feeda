...
class Config:
    ...
    # Same 3h TTL as PAIR_TTL_SECONDS — long enough that a share link sent
    # elsewhere (chat, email) can still be opened well after it was sent,
    # not just within a couple minutes. Generating a fresh link invalidates
