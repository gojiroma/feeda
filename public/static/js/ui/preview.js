...
export function renderPreview(container, entry, query, { onLinkClick, logEntry, onSetColor, onAddComment } = {}) {
  container.innerHTML = "";
  ...
  if (onSetColor && onAddComment) {
    ...
    renderAnnotatePopup(annotateWrap, { logEntry, onSetColor, onAddComment, autoFocus: false });
