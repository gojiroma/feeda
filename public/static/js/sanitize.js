...
// — pulled from the same allowlisted fragment sanitizeHtmlToFragment
// builds, so the <img src> and text it surfaces can't smuggle in anything
// that wouldn't already be let through.
